  ...
  return (
    ...
    <section className='bg-white'>
        ...
        <div className='container flex items-center justify-center relative pl-10 lg:pl-0'>
            ...
            {/* Olide */}
            <div className='left-10 absolute -top-12 lg:left-0 w-24 h-24 bg-orange-300 rounded-full flex items-center'>
                <p className='uppercase font-bold text-xl text-rose-500 text-center -rotate-45 '>Oldie & Goldie</p>
            </div>
        </div>
        </div>
    </section>
